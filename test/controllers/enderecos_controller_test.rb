...
class EnderecosControllerTest < ActionController::TestCase
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post :create, endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, estado: @endereco.estado, nome: @endereco.nome, numero: @endereco.numero, rua: @endereco.rua, user_id: @endereco.user_id }
    end
  ...
  test "should update endereco" do
    patch :update, id: @endereco, endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, estado: @endereco.estado, nome: @endereco.nome, numero: @endereco.numero, rua: @endereco.rua, user_id: @endereco.user_id }
    assert_redirected_to endereco_path(assigns(:endereco))
  end
